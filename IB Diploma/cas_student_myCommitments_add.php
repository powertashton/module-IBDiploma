...
if (isActionAccessible($guid, $connection2, "/modules/IB Diploma/cas_student_myCommitments_add.php")==FALSE) {
	...
	if (enroled($guid, $_SESSION[$guid]["gibbonPersonID"], $connection2)==FALSE) {
		...
		if ($step==1) {
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/cas_student_myCommitments_add.php&step=2" ?>">
			...
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/cas_student_myCommitments_addProcess.php" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					<tr class='break'>
						<td colspan=2> 
					...
					<tr>
						...
						<td class="right">
							<input type='text' style='width: 302px' name='name' id='name' value='<?php if (isset($rowActivity["name"])) { print $rowActivity["name"] ; } ?>' maxlength=50>
							<script type="text/javascript">
					...
					<tr>
						...
						<td class="right">
							<input name="dateStart" id="dateStart" maxlength=10 <?php if (isset($rowActivity["programStart"])) {  if ($rowActivity["programStart"]!="") { print "value='" . dateConvertBack($rowActivity["programStart"]) . "'" ; } } ?> type="text" style="width: 300px">
							<script type="text/javascript">
					...
					<tr>
						...
						<td class="right">
							<input name="dateEnd" id="dateEnd" maxlength=10 value="<?php if (isset($rowActivity["programEnd"])) { print dateConvertBack($rowActivity["programEnd"]) ; } ?>" type="text" style="width: 300px">
							<script type="text/javascript">
					...
					<tr>
						...
						<td class="right">
							<input type='text' style='width: 302px' name='supervisorName' id='supervisorName' value='<?php if (isset($rowCoord["surname"])) { if ($rowCoord["surname"]!="") { print formatName("", $rowCoord["preferredName"], $rowCoord["surname"], "Staff", true, true) ; } } ?>' maxlength=100>
							<script type="text/javascript">
					...
					<tr>
						...
						<td class="right">
							<input type='text' style='width: 302px' name='supervisorEmail' id='supervisorEmail' value='<?php if (isset($rowCoord["email"])) { print $rowCoord["email"] ; } ?>' maxlength=255>
							<script type="text/javascript">
					...
					<tr>
						...
						<td class="right">
							<input type='text' style='width: 302px' name='supervisorPhone' id='supervisorPhone' value='<?php if (isset($rowCoord["phone1"])) { print $rowCoord["phone1"] ; } ?>' maxlength=20>
							<script type="text/javascript">
