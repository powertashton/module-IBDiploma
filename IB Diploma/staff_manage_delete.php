...
if (isActionAccessible($guid, $connection2, '/modules/IB Diploma/staff_manage_delete.php') == false) {
    ...
    if ($ibDiplomaCASStaffID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            $row = $result->fetch();
            ?>
			<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/'.$_SESSION[$guid]['module']."/staff_manage_deleteProcess.php?ibDiplomaCASStaffID=$ibDiplomaCASStaffID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">
					<tr>
						<td>
							<b>Are you sure you want to delete "<?php echo formatName('', $row['preferredName'], $row['surname'], 'Staff', true, true) ?>" from the CAS programme?</b><br/>
					...
					<tr>
						<td>
							<input name="ibDiplomaCASStaffID" id="ibDiplomaCASStaffID" value="<?php echo $ibDiplomaCASStaffID ?>" type="hidden">
