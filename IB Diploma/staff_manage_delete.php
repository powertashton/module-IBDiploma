...
if (isActionAccessible($guid, $connection2, "/modules/IB Diploma/staff_manage_delete.php")==FALSE) {
	...
	if ($ibDiplomaCASStaffID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/staff_manage_deleteProcess.php?ibDiplomaCASStaffID=$ibDiplomaCASStaffID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					<tr>
						<td> 
							<b>Are you sure you want to delete "<?php print formatName("", $row["preferredName"], $row["surname"], "Staff", true, true) ?>" from the CAS programme?</b><br/>
					...
					<tr>
						<td> 
							<input name="ibDiplomaCASStaffID" id="ibDiplomaCASStaffID" value="<?php print $ibDiplomaCASStaffID ?>" type="hidden">
