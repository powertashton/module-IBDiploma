...
CHANGE `1_notes` `1_notes` TEXT,
CHANGE `2_notes` `2_notes` TEXT,
CHANGE `2_outcome1` `2_outcome1` TEXT,
CHANGE `2_outcome2` `2_outcome2` TEXT,
CHANGE `2_outcome3` `2_outcome3` TEXT,
CHANGE `2_outcome4` `2_outcome4` TEXT,
CHANGE `2_outcome5` `2_outcome5` TEXT,
CHANGE `2_outcome6` `2_outcome6` TEXT,
CHANGE `2_outcome7` `2_outcome7` TEXT,
CHANGE `2_outcome8` `2_outcome8` TEXT,
CHANGE `3_outcome1` `3_outcome1` TEXT,
CHANGE `3_outcome1Notes` `3_outcome1Notes` TEXT,
CHANGE `3_outcome2` `3_outcome2` TEXT,
CHANGE `3_outcome2Notes` `3_outcome2Notes` TEXT,
CHANGE `3_outcome3` `3_outcome3` TEXT,
CHANGE `3_outcome3Notes` `3_outcome3Notes` TEXT,
CHANGE `3_outcome4` `3_outcome4` TEXT,
CHANGE `3_outcome4Notes` `3_outcome4Notes` TEXT,
CHANGE `3_outcome5` `3_outcome5` TEXT,
CHANGE `3_outcome5Notes` `3_outcome5Notes` TEXT,
CHANGE `3_outcome6` `3_outcome6` TEXT,
CHANGE `3_outcome6Notes` `3_outcome6Notes` TEXT,
CHANGE `3_outcome7` `3_outcome7` TEXT,
CHANGE `3_outcome7Notes` `3_outcome7Notes` TEXT,
CHANGE `3_outcome8` `3_outcome8` TEXT,
CHANGE `3_outcome8Notes` `3_outcome8Notes` TEXT;end

ALTER TABLE `ibDiplomaCASCommitment`
CHANGE `description` `description` TEXT,
CHANGE `goals` `goals` VARCHAR(255);end';
