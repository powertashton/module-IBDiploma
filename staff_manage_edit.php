...
if (isActionAccessible($guid, $connection2, "/modules/IB Diploma/staff_manage_edit.php")==FALSE) {
	...
	if ($ibDiplomaCASStaffID=="Y") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/staff_manage_editProcess.php?ibDiplomaCASStaffID=$ibDiplomaCASStaffID" ?>">
